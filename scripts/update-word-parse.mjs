...
async function queryDeepseekAPI(word) {
  ...
  # 角色
  你是一名中英文双语教育专家，拥有帮助将中文视为母语的用户理解和记忆英语单词的专长，请根据英语单词 "${word}" 完成下列任务。
  ...
  ### 列举例句
  - 根据所需，为该单词提供至少 3 个不同场景下的使用方法和例句，对应的单词高亮显示。并且附上中文翻译，以帮助用户更深入地理解单词意义。
  ...
  以下是返回格式示例，内容上如果有双引号，注意进行反义处理：
  {
    ...
    "examples": [
      ...
      {
        "context": "Law Enforcement Context",
    ...
    "word_forms": {
      "noun": "agent (代理人；特工；作用物)",
      "plural": "agents (代理人；特工；作用物)",
      "adjective": "agentive (代理的)",
      "phrases": [
        "secret **agent** (特工)",
        "travel **agent** (旅行社)",
        "cleaning **agent** (清洁剂)"
