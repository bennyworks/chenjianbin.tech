...
export default function WordAnalysis({ initialWordTypes, initialWords }: WordAnalysisProps) {
  ...
  const handleTypeSelect = useCallback((typeId: number) => {
    setIsLoading(true)
      ...
      {!selectedWord ? (
        ...
        <Card className="overflow-hidden">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold mb-4">{selectedWord.word}</CardTitle>
            <div className="flex justify-center space-x-8 text-base">
              <div className="flex items-center">
                <Button variant="secondary" size="sm" className="h-8 px-2 mr-2">
          ...
          <CardContent className="p-6">
            <div className="grid lg:grid-cols-[1fr,400px] gap-8">
              ...
              <div className="space-y-6">
                <section>
                  <h4 className="text-lg font-semibold mb-3">分析词义</h4>
                ...
                <section>
                  <h4 className="text-lg font-semibold mb-3">词根分析</h4>
                  <p className="mb-2">
                    词根：
                ...
                <section>
                  <h4 className="text-lg font-semibold mb-3">词缀分析</h4>
                  <div className="space-y-2">
                    ...
                    <p>
                      ...
                      {selectedWord.parseJson?.affix_analysis?.root || 'N/A'}
                    </p>
                    <p>
                ...
                <section>
                  <h4 className="text-lg font-semibold mb-3">单词变形</h4>
                  <div className="space-y-2">
                    <p>
                      <span className="font-medium">名词：</span>
                    ...
                    <p>
                      <span className="font-medium">形容词：</span>
                      {selectedWord.parseJson?.word_forms?.adjective || 'N/A'}
                    </p>
                  </div>
                  <div className="mt-4">
                    <p className="font-medium mb-2">常见短语：</p>
                    <div className="space-y-2">
                  ...
                  {selectedWord.parseJson?.examples?.map((example: any, index: number) => (
                    <Card key={index}>
                      <CardHeader className="p-3">
                        <CardTitle className="text-base font-medium">{example.context}</CardTitle>
                      </CardHeader>
